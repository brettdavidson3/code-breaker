...
public class WordList {
    ...
    public static List<String> getWordList(World.Difficulty difficulty) {
        switch (difficulty) {
            case Easy: return easyWordList();
            case Hard: return hardWordList();
            default: return normalWordList();
        }
    }
